...
public class Hegaldia extends JFrame {
	...
	public Hegaldia(int erabiltzailezbk, ArrayList<Bidaia> bidaiak, int IDLerroa) {
		...
		// Crear un modelo de fecha para el JSpinner (establecer hora, minutos y
		// segundos)
		...
		atzeraHButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				dispose();
			}
		});
		...
		prezioaJField.setText("barne");
		prezioaJField.setEditable(false);
		...
		irteeraJField.setEditable(false);
		...
		helmugaJField.setEditable(false);
		...
		gordeHButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Zerbitzua hegaldia = new Zerbitzua(aireportuHIrteera, aireportuHHelmuga, kodeaH, airelineaH,
						prezioHegaldiaH, irteeraHData, orduaIrteeraH, iraupenaH, IDLerroa, 0);
				...
				if (etorriCheckBox.isSelected()) {
					...
					Zerbitzua etorriHegaldia = new Zerbitzua(IDHegaldia, aireportuJIrteera, aireportuJHelmuga,
							irteeraJData, orduaIrteeraJ, iraupenaJ, kodeaJ, airelineaJ, 1);
